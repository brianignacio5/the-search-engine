...
from tsg.indexer.page_rank import parse_link, build_link_database, get_page_outlinks, calc_page_rank
...
def test_calc_page_rank():
	...
	test_pagerank_per_doc = [('journal_ijea_ijea5.html', 0.7767886178861788), 
							 ('author_t_Tran:Quang=Dung.html', 0.5885907859078591), 
							 ('author_m_Miao:Jian=Jun.html', 0.5885907859078591), 
							 ('author_a_A:Almaaf_Bader_Ali.html', 0.5885907859078591), 
							 ('author_z_Zhou:Tao.html', 0.17073170731707318), 
							 ('author_z_Zhao:Jensen.html', 0.17073170731707318), 
							 ('author_z_Zhang:Jeff.html', 0.17073170731707318), 
							 ('author_z_Zhang:Changzheng.html', 0.17073170731707318), 
							 ...
							 ('author_h_Hsu:Pi=Fang.html', 0.17073170731707318), 
							 ...
							 ('author_h_Harris:Tom.html', 0.17073170731707318), 
							 ...
							 ('journal_journals_lncs.html', 0), 
							 ('author_y_Yakushev:Alexey_Rodriguez.html', 0), 
							 ('author_s_Schmid:Ute.html', 0), 
							 ('author_r_Ram=iacute=rez=Quintana:M=_Jos=eacute=.html', 0), 
							 ('author_p_Plasmeijer:Rinus.html', 0), 
							 ('author_m_Mitchell:Neil.html', 0), 
							 ('author_k_Koopman:Pieter_W=_M=.html', 0), 
							 ('author_k_Kitzelmann:Emanuel.html', 0), 
							 ('author_k_Katayama:Susumu.html', 0), 
							 ('author_j_Jeuring:Johan.html', 0), 
							 ('author_h_Hofmann_0008:Martin.html', 0), 
							 ('author_h_Hieber:Thomas.html', 0), 
							 ('author_h_Hern=aacute=ndez=Orallo:Jos=eacute=.html', 0), 
							 ('author_h_Henderson:Robert.html', 0), 
							 ('author_f_Ferri:C=eacute=sar.html', 0), 
							 ('author_e_Estruch:Vicent.html', 0)]

	pagerank_per_doc = calc_page_rank(RAW_TEST_DIRECTORY)
